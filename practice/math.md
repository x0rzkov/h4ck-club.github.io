...
vector projection, cosine similarity, orthogonal vectors, normal and orthonormal vectors, 
vector norm, vector space, linear combination, linear span, linear independence, basis vectors
```
###### Matrices
```
definition, addition, transpose, scalar multiplication, matrix multiplication, 
matrix multiplication properties, hadamard product, functions, linear transformation, 
determinant, identity matrix, invertible matrix and inverse, rank, trace, 
...
```
Functions
Scalar derivative definition, intuition, common rules of differentiation, chain rule, 
partial derivatives
```
###### Gradient
```
